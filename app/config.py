...
class Settings:
    DATABASE_URL = os.getenv("DATABASE_URL") or         f"postgresql+psycopg2://{os.getenv('POSTGRES_USER','perspectiva')}:{os.getenv('POSTGRES_PASSWORD','perspectiva')}@db:5432/{os.getenv('POSTGRES_DB','perspectiva')}"
